        ...
        <div class="bd cf">
            ...
            <div class="fr userEntry">
                <div class="userBox fl">
                    <img src="/book/static/images/user.jpg" class="pic j_headPic" />
                ...
                <a href="/book/cart/cart.jsp" class="cart">换书车<em></em></a>
            </div>
...
<div class="ui-tab mb30">
    <ul class="cf j_agencyTab">
        ...
        <li class="tabItem"><a href="./apply.jsp">代理资料</a></li>
                    ...
                    <div class="ui-form-group">
                        <div class="uploadBox cf">
                            <div class="uploadItem fl">
                                <img src="/book/static/images/core/boy1.jpg" class="pic" />
...
<script src="/book/static/js/agency/agency.js"></script>
</body>
</html>