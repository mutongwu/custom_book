...
<div class="wrapper">
    ...
    <div class="container couponCodeCnt">
        ...
        <div class="btnBox fs18 tc">
            <div class="applyType">
                <a class="ui-button ui-button-L ui-button-yellow" href="./agency/apply.html">个人代理</a>
                <p class="green">人人都可以申请</p>
            </div>
            <div class="applyType">
                <a class="ui-button ui-button-L ui-button-yellow" href="./agency/apply_eshop.html">网店代理</a>
                <p class="green">要求有网络店铺</p>
            </div>
            <div class="applyType">
                <a class="ui-button ui-button-L ui-button-yellow" href="./agency/apply_eshop.html">实体店代理</a>
